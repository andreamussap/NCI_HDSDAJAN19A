...
retain_cols <- c("User_ID","Product_ID","Gender","Age","Stay_In_Current_City_Years",
                 "Purchase","Status_Desc","OccupationDesc","Location","Latitude",
                 "Longitude","GrapeType","Wine_Type","saleDate")
